...
- Top-level sections (direct children of the page) live under virtual parent "morph".
- To move whole sections (e.g. swap a table block and a chart block), call reorder_children with parentPath "morph" and childOrder using segments from snapshot.nodes.
...
- Do not refuse top-level section reorder — use parentPath "morph" as described above.
